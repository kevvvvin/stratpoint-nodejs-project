...
const register = async (req: Request<RegisterRequestBody> , res: Response, next: NextFunction): Promise<Response | void> => {
...
const login = async (req: Request<LoginRequestBody>, res: Response, next: NextFunction): Promise<Response | void> => {
